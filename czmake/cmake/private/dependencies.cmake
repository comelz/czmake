FUNCTION(RESOLVE_DEPENDENCIES)
    ...
    if(NOT CZMAKE_REPODIR)
        set(CZMAKE_REPODIR ${CMAKE_SOURCE_DIR}/lib)
    endif()
    set(CACHE_FILE "${CZMAKE_REPODIR}/.czmake_cmake_cache.txt")
    ...
    endforeach()
    execute_process(COMMAND ${PYTHON_EXECUTABLE_3} -m czmake.dependency_solver -b ${CMAKE_BINARY_DIR} -s ${CMAKE_CURRENT_SOURCE_DIR} -r ${CZMAKE_REPODIR} -f ${CACHE_FILE}
