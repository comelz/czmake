...
ELSE()
  ...
  IF(SIP_FOUND)
    ...
    set(SIP_VERSION ${SIP_VERSION} CACHE STRING "")
    set(SIP_VERSION_STR ${SIP_VERSION_STR} CACHE STRING "")
    set(SIP_EXECUTABLE ${SIP_EXECUTABLE} CACHE STRING "")
    set(SIP_INCLUDE_DIR ${SIP_INCLUDE_DIR} CACHE STRING "")
  ELSE()
