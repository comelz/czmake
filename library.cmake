...
FUNCTION(CREATE_TARGET NAME)
    ...
    foreach(TGT ${TGTS})
        ...
        if(CMAKE_COMPILER_IS_GNUCXX)
            ...
            if(CMAKE_INTERPROCEDURAL_OPTIMIZATION)
                list(APPEND COMPILE_OPTS -fuse-linker-plugin)
                list(APPEND LINK_OPTS -fuse-linker-plugin)
            endif()
            if(CMAKE_BUILD_TYPE STREQUAL "Debug")
                target_compile_definitions(${TGT} PRIVATE _GLIBCXX_DEBUG)
                list(APPEND COMPILE_OPTS -ftrapv)
            endif()
            target_compile_options(${TGT} PRIVATE ${COMPILE_OPTS})
            target_link_libraries(${TGT} PRIVATE ${LINK_OPTS})
        endif()
    endforeach()
ENDFUNCTION()
